...
public class GrupoDAOImpl implements GrupoDAO {
	...
	public Grupo findGrupoAluno(Long idSemestre, Long idGrupo) {
		...
		hql.append("left join uniweb.relatorio as rel2 on rel2.fkaluno=gru.idaluno and rel2.fkgrupocampoestagio = ");
		hql.append("(select gc1.id from uniweb.grupocampoestagio gc1 inner join uniweb.grupocampoestagio gc2 on gc1.datainicial>=gc2.datainicial and gc2.fkgrupo=:idGrupo ");
		hql.append("where gc1.fkgrupo = :idGrupo group by gc1.datainicial, gc1.id, gc1.fkgrupo having count(*) = 2) ");
		hql.append("left join uniweb.relatorio as rel3 on rel3.fkaluno=gru.idaluno and rel3.fkgrupocampoestagio = ");
		hql.append("(select gc1.id from uniweb.grupocampoestagio gc1 inner join uniweb.grupocampoestagio gc2 on gc1.datainicial>=gc2.datainicial and gc2.fkgrupo=:idGrupo ");
		hql.append("where gc1.fkgrupo = :idGrupo group by gc1.datainicial, gc1.id, gc1.fkgrupo having count(*) = 3) ");
		hql.append("left join uniweb.relatorio as rel4 on rel4.fkaluno=gru.idaluno and rel4.fkgrupocampoestagio = ");
		hql.append("(select gc1.id from uniweb.grupocampoestagio gc1 inner join uniweb.grupocampoestagio gc2 on gc1.datainicial>=gc2.datainicial and gc2.fkgrupo=:idGrupo ");
		hql.append("where gc1.fkgrupo = :idGrupo group by gc1.datainicial, gc1.id, gc1.fkgrupo having count(*) = 4) ");
		hql.append("left join uniweb.relatorio as rel5 on rel5.fkaluno=gru.idaluno and rel5.fkgrupocampoestagio = ");
		hql.append("(select gc1.id from uniweb.grupocampoestagio gc1 inner join uniweb.grupocampoestagio gc2 on gc1.datainicial>=gc2.datainicial and gc2.fkgrupo=:idGrupo ");
